...
import 'package:catchup_app/screens/input/add_payment_screen.dart';
import 'package:catchup_app/widgets/cards/payment_card_view.dart';
              ...
              return Column(
                children: [
                  PaymentCardView(
                    ...
                    expiryDateString: "${_cardDetailsController.cardDetailList.elementAt(index).month}/${_cardDetailsController.cardDetailList.elementAt(index).year}",
